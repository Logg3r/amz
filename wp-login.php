<!DOCTYPE html>
	...
	<title>Acessar &lsaquo; Amazing Monkeys &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
		...
		&larr; Voltar para Amazing Monkeys		</a></p>
			</div>
...
<script>
var _wpUtilSettings = {"ajax":{"url":"\/amz\/wp-admin\/admin-ajax.php"}};
</script>
<script src='./wp-includes/js/wp-util.min.js?ver=5.3.2'></script>
<script>
var userProfileL10n = {"warn":"Sua nova senha n\u00e3o foi salva.","warnWeak":"Confirmar o uso de uma senha fraca","show":"Mostrar","hide":"Esconder","cancel":"Cancelar","ariaShow":"Mostrar senha","ariaHide":"Ocultar senha"};
</script>
